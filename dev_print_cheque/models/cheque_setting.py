...
class cheque_setting(models.Model):
    ...
    partner_address_top_margin = fields.Float('From Top')
    partner_address_left_margin = fields.Float('From Top')
    ...
    is_footer_text_bold = fields.Boolean('Font Bold')
    cheque_footer_text = fields.Char('Footer Text')
    footer_font_size = fields.Integer('Font Size', default=13)
    footer_m_top = fields.Float('From Top', default=240)
    footer_m_left = fields.Float('From Top', default=240)
