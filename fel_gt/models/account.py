...
class AccountInvoice(models.Model):
    ...
    def requiere_certificacion(self):
        self.ensure_one()
        factura = self
        return factura.amount_total != 0 and factura.journal_id.generar_fel
    ...
    def dte_documento(self):
        ...
        if not factura.firma_fel and factura.amount_total != 0:
            ...
            if tipo_documento_fel in ['FACT', 'FCAM'] and factura.type == 'out_refund':
...
class AccountJournal(models.Model):
    ...
    generar_fel = fields.Boolean('Generar FEL', copy=False)
