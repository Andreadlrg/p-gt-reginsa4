...
class AccountInvoice(models.Model):
    ...
    def invoice_validate(self):
        for factura in self:
            if factura.journal_id.usuario_fel and factura.journal_id.generar_fel:
                ...
                if dte:
                    ...
                    if len(resultadoXML.xpath("//token")) > 0:
                        ...
                        if len(resultadoXML.xpath("//listado_documentos//estado_documento//tipo_respuesta")) > 0 and resultadoXML.xpath("//listado_documentos//estado_documento//tipo_respuesta")[0].text == '0':
                            ...
                            #raise UserError(uuid_existente)
                            headers = { "Content-Type": "application/xml", "authorization": "Bearer "+token }
                            ...
                            #factura.name = numero_autorizacion_ex.get("Serie")+"-"+numero_autorizacion_ex.get("Numero")
    ...
    def action_cancel(self):
        ...
        for factura in self:
            if factura.journal_id.usuario_fel and factura.firma_fel and factura.journal_id.generar_fel:
